...
9,11,13,15,16 : unfold ptree_formula, demorgan2_sub_formula, formula_sub_ind, formula_sub_ind_fit, form_eqb;
                destruct S;
                try reflexivity.
...
4 : { destruct PV as [[[[[[[P1F P1V] P2F] P2V] P1D] P2D] P1O] P2O].
      ...
      destruct EQ1,EQ2.
      case (nat_eqb n0 (ptree_deg (demorgan_ab f f0 n n0 o o0 P1 P2))) eqn:EQ;
      unfold ptree_formula; fold ptree_formula;
      apply P2F. }
...
5 : { destruct PV as [[[[[[[P1F P1V] P2F] P2V] P1D] P2D] P1O] P2O].
      ...
      { rewrite P2F.
        ...
        apply FS'. }
      case (nat_eqb n0 (ptree_deg (demorgan_abd f f0 f1 n n0 o o0 P1 P2))) eqn:EQ;
      unfold ptree_formula; fold ptree_formula;
...
4-6 : case (form_eqb f E) eqn:EQ1;
      case (form_eqb f0 F) eqn:EQ2;
      unfold ptree_deg; fold ptree_deg;
      case (nat_eqb n0 (Nat.max n n0)) eqn:EQ;
      try reflexivity.
...
11,15 : case (nat_eqb n0 (Nat.max n n0)) eqn:EQ.
