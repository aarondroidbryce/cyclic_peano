...
apply (loop1 _ _ FREEA P1'). fold node_extract. rewrite <- P2N. apply P2'.
apply (loop2 _ _ FREEA P1'). fold node_extract. rewrite <- P2N. apply P2'.
Qed.
